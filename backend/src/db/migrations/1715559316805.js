module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('live_sessions', 'link', {
        transaction,
      });

      await queryInterface.removeColumn('live_sessions', 'platform', {
        transaction,
      });

      await queryInterface.removeColumn('live_sessions', 'scheduled_time', {
        transaction,
      });

      await queryInterface.removeColumn('live_sessions', 'courseId', {
        transaction,
      });

      await queryInterface.removeColumn('enrollments', 'payment_status', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('discussion_boards', 'description', {
        transaction,
      });

      await queryInterface.removeColumn('discussion_boards', 'topic', {
        transaction,
      });

      await queryInterface.removeColumn('discussion_boards', 'courseId', {
        transaction,
      });

      await queryInterface.removeColumn('courses', 'end_date', { transaction });
      ...
      await queryInterface.dropTable('live_sessions', { transaction });
